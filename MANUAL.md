...
1.  Скачать архивом из `какой-то ветки`
...
МЕНЮ+Загрузки---+Загрузить Участников
    ...
    |                               +в Excel
    |                        
    +Волшебство-+Рассадить                              # TODO:
                +Закрепить на ключ--+всех               # TODO:
                |                   +по email           # TODO:
                |
                +Открепить от ключа-+по ключу           # TODO:
                |                   +по email           # TODO:
                |
                +Отметка о прибытии                     # TODO:
                +Удалить------------+по местам          # TODO:
                |                   +по email           # TODO:
                |                   +всех               # TODO:
                |
                +Опасно-------------+Обновить-------+по местам  # TODO:
                                    |               +по email   # TODO:
                                    |                                           
                                    |Очень опасно---+Удалить загрузочный файл   # TODO:
                                                    +Удалить аудиторию          # TODO:
```
# Инструкция
После первой загрузки будет примерно такой экран:
![img1](img\first_launch.png)
## Загрузки
...
* Входной формат: `*.xlsx` 
    Столбцы: `email[|...|...]`
    *В квадрантых скобках необязательные входные столбцы, троеточие = любое значение*
...
* Результат:
    ...
    В информации по загруженным появится количество загруженных emails
...
![img1](img\razdatka.png)
### Карты
Открывает диалог для сохранения файла вида(там для каждой аудитории)

* С классами
    ![img1](img\with_klass.png)
* C местами
    ![img1](img\with_seats.png)
    
### Аудитории
Открывает диалог для сохранения файла вида(там для каждой аудитории)
![img1](img\aud_stat.png)
...
![img1](img\set_glob.png)
![img1](img\aud_aud.png)
![img1](img\aud_choice.png)
