...
class TkTools:
    ...
    @staticmethod
    def _create_menu(parent, dictionary, cascadeopts=None, menuopts=None, itemopts=None, menubindage=None):
        """
        loop initial
        ...
        for key, item in dictionary.items():
            if type(item) is dict:
                ...
                TkTools._create_menu(child, item, cascadeopts, menuopts, itemopts)
